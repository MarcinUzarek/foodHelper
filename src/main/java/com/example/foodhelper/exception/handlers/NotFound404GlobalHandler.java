...
public class NotFound404GlobalHandler {
    ...
    @ResponseBody
    public ResponseEntity<ExceptionDetails> handleUserNotFound(UserNotFoundException e) {
    ...
    @ResponseBody
    public ResponseEntity<ExceptionDetails> handleWrongCredentials(WrongCredentialsException e) {

        return new ResponseEntity<>(new ExceptionDetails(ZonedDateTime.now(),
                NOT_FOUND, e.getMessage()), NOT_FOUND);
    }

    @ExceptionHandler(IntoleranceNotFoundException.class)
    @ResponseBody
    public ResponseEntity<ExceptionDetails> handleIntoleranceNotFound(IntoleranceNotFoundException e) {
    ...
    @ResponseBody
    public ResponseEntity<ExceptionDetails> handleRoleNotExists(RoleNotExistsException e) {
